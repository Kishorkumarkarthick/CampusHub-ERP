  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        <h2 className="text-3xl font-extrabold tracking-tight">Student Sign In</h2>
        <p className="text-sm text-muted-foreground">
          Enter your credential keys to check your academic dashboard.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full py-3 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 active:scale-[0.98] transition-all flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/10 cursor-pointer disabled:opacity-75 disabled:pointer-events-none"
          disabled={localLoading}
        >
          {localLoading ? (
            <>
      ...
      <div className="pt-4 border-t border-border/40 space-y-3">
        ...
        <div className="p-3 bg-secondary/50 rounded-xl border border-border/50 text-[11px] text-muted-foreground leading-relaxed flex flex-col gap-1 select-all">
          <div><span className="font-semibold text-secondary-foreground">Email:</span> student@college.edu</div>
